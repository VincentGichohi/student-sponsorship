# Generated by Django 3.2.7 on 2021-11-08 08:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Sponsor',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='sponsorship.myuser')),
            ...
            options={
                'permissions': (('can view sponsorship', 'view sponsorship application'), ('can sponsor', 'sponsor')),
            },
        ),
        migrations.CreateModel(
            name='Student',
            ...
            options={
                'permissions': (('can apply for sponsorship', 'apply for sponsorship'), ('view sponsorship applications', 'view applications')),
            },
        ),
        migrations.CreateModel(
            name='Applications',
